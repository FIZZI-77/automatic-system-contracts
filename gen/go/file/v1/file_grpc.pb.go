...
const (
	...
	FileService_LinkFile_FullMethodName          = "/file.v1.FileService/LinkFile"
	FileService_GetDownloadURL_FullMethodName    = "/file.v1.FileService/GetDownloadURL"
	FileService_ListResourceFiles_FullMethodName = "/file.v1.FileService/ListResourceFiles"
...
type FileServiceClient interface {
	...
	ListResourceFiles(ctx context.Context, in *ListResourceFilesRequest, opts ...grpc.CallOption) (*ListResourceFilesResponse, error)
...
func (c *fileServiceClient) ListResourceFiles(ctx context.Context, in *ListResourceFilesRequest, opts ...grpc.CallOption) (*ListResourceFilesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListResourceFilesResponse)
	err := c.cc.Invoke(ctx, FileService_ListResourceFiles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileServiceServer interface {
	...
	ListResourceFiles(context.Context, *ListResourceFilesRequest) (*ListResourceFilesResponse, error)
...
func (UnimplementedFileServiceServer) LinkFile(context.Context, *LinkFileRequest) (*LinkFileResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method LinkFile not implemented")
}
...
func (UnimplementedFileServiceServer) ListResourceFiles(context.Context, *ListResourceFilesRequest) (*ListResourceFilesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListResourceFiles not implemented")
}
...
func _FileService_ListResourceFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListResourceFilesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServiceServer).ListResourceFiles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_ListResourceFiles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).ListResourceFiles(ctx, req.(*ListResourceFilesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListResourceFiles",
			Handler:    _FileService_ListResourceFiles_Handler,
		},
		{
