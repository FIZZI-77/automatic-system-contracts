...
type ChangePasswordRequest struct {
	...
	RevokeOtherSessions *bool                  `protobuf:"varint,5,opt,name=revoke_other_sessions,json=revokeOtherSessions,proto3,oneof" json:"revoke_other_sessions,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ChangePasswordRequest) GetRevokeOtherSessions() bool {
	if x != nil && x.RevokeOtherSessions != nil {
...
func (x *Role) GetCreatedAtUnix() int64 {
	if x != nil {
...
func (x *RoleMutationResponse) Reset() {
	*x = RoleMutationResponse{}
	mi := &file_auth_v1_auth_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RoleMutationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RoleMutationResponse) ProtoMessage() {}

func (x *RoleMutationResponse) ProtoReflect() protoreflect.Message {
	mi := &file_auth_v1_auth_proto_msgTypes[29]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RoleMutationResponse.ProtoReflect.Descriptor instead.
func (*RoleMutationResponse) Descriptor() ([]byte, []int) {
	return file_auth_v1_auth_proto_rawDescGZIP(), []int{29}
}

func (x *RoleMutationResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *RoleMutationResponse) GetRole() *Role {
	if x != nil {
		return x.Role
	}
	return nil
...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\tjwks_json\x18\x01 \x01(\tR\bjwksJson\"\xe8\x01\n" +
	...
	"\x15revoke_other_sessions\x18\x05 \x01(\bH\x00R\x13revokeOtherSessions\x88\x01\x01B\x18\n" +
	"\x16_revoke_other_sessions\"p\n" +
	"\x16ChangePasswordResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12<\n" +
	"\x1ainvalidated_sessions_count\x18\x02 \x01(\rR\x18invalidatedSessionsCount\"M\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12<\n" +
	"\x1ainvalidated_sessions_count\x18\x02 \x01(\rR\x18invalidatedSessionsCount\"t\n" +
	"\x04Role\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12&\n" +
	"\x0fcreated_at_unix\x18\x04 \x01(\x03R\rcreatedAtUnix\"I\n" +
	...
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1b\n" +
	"\trole_name\x18\x02 \x01(\tR\broleName\"S\n" +
	"\x14RoleMutationResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12!\n" +
	"\x04role\x18\x02 \x01(\v2\r.auth.v1.RoleR\x04role2\xb5\t\n" +
	"\vAuthService\x12?\n" +
	...
	"\rResetPassword\x12\x1d.auth.v1.ResetPasswordRequest\x1a\x1e.auth.v1.ResetPasswordResponse\x12G\n" +
	"\n" +
	"CreateRole\x12\x1a.auth.v1.CreateRoleRequest\x1a\x1d.auth.v1.RoleMutationResponse\x12G\n" +
	"\n" +
	"DeleteRole\x12\x1a.auth.v1.DeleteRoleRequest\x1a\x1d.auth.v1.RoleMutationResponse\x12G\n" +
	"\n" +
	"AssignRole\x12\x1a.auth.v1.AssignRoleRequest\x1a\x1d.auth.v1.RoleMutationResponse\x12G\n" +
	"\n" +
	"RemoveRole\x12\x1a.auth.v1.RemoveRoleRequest\x1a\x1d.auth.v1.RoleMutationResponseB8Z6github.com/FIZZI-77/automatic-system-contracts/auth/v1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*SendVerificationEmailRequest)(nil),  // 16: auth.v1.SendVerificationEmailRequest
	(*SendVerificationEmailResponse)(nil), // 17: auth.v1.SendVerificationEmailResponse
	(*VerifyEmailRequest)(nil),            // 18: auth.v1.VerifyEmailRequest
	(*VerifyEmailResponse)(nil),           // 19: auth.v1.VerifyEmailResponse
	...
	(*CreateRoleRequest)(nil),             // 25: auth.v1.CreateRoleRequest
	(*DeleteRoleRequest)(nil),             // 26: auth.v1.DeleteRoleRequest
	(*AssignRoleRequest)(nil),             // 27: auth.v1.AssignRoleRequest
	(*RemoveRoleRequest)(nil),             // 28: auth.v1.RemoveRoleRequest
	(*RoleMutationResponse)(nil),          // 29: auth.v1.RoleMutationResponse
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	24, // 0: auth.v1.RoleMutationResponse.role:type_name -> auth.v1.Role
	...
	8,  // 5: auth.v1.AuthService.LogoutAll:input_type -> auth.v1.LogoutAllRequest
	10, // 6: auth.v1.AuthService.GetUserAuthInfo:input_type -> auth.v1.GetUserAuthInfoRequest
	12, // 7: auth.v1.AuthService.GetJWKS:input_type -> auth.v1.GetJWKSRequest
	14, // 8: auth.v1.AuthService.ChangePassword:input_type -> auth.v1.ChangePasswordRequest
	16, // 9: auth.v1.AuthService.SendVerificationEmail:input_type -> auth.v1.SendVerificationEmailRequest
	18, // 10: auth.v1.AuthService.VerifyEmail:input_type -> auth.v1.VerifyEmailRequest
	20, // 11: auth.v1.AuthService.RequestPasswordReset:input_type -> auth.v1.RequestPasswordResetRequest
	22, // 12: auth.v1.AuthService.ResetPassword:input_type -> auth.v1.ResetPasswordRequest
	25, // 13: auth.v1.AuthService.CreateRole:input_type -> auth.v1.CreateRoleRequest
	26, // 14: auth.v1.AuthService.DeleteRole:input_type -> auth.v1.DeleteRoleRequest
	27, // 15: auth.v1.AuthService.AssignRole:input_type -> auth.v1.AssignRoleRequest
	28, // 16: auth.v1.AuthService.RemoveRole:input_type -> auth.v1.RemoveRoleRequest
	...
	5,  // 19: auth.v1.AuthService.Refresh:output_type -> auth.v1.RefreshResponse
	7,  // 20: auth.v1.AuthService.Logout:output_type -> auth.v1.LogoutResponse
	9,  // 21: auth.v1.AuthService.LogoutAll:output_type -> auth.v1.LogoutAllResponse
	11, // 22: auth.v1.AuthService.GetUserAuthInfo:output_type -> auth.v1.GetUserAuthInfoResponse
	13, // 23: auth.v1.AuthService.GetJWKS:output_type -> auth.v1.GetJWKSResponse
	15, // 24: auth.v1.AuthService.ChangePassword:output_type -> auth.v1.ChangePasswordResponse
	17, // 25: auth.v1.AuthService.SendVerificationEmail:output_type -> auth.v1.SendVerificationEmailResponse
	19, // 26: auth.v1.AuthService.VerifyEmail:output_type -> auth.v1.VerifyEmailResponse
	21, // 27: auth.v1.AuthService.RequestPasswordReset:output_type -> auth.v1.RequestPasswordResetResponse
	23, // 28: auth.v1.AuthService.ResetPassword:output_type -> auth.v1.ResetPasswordResponse
	29, // 29: auth.v1.AuthService.CreateRole:output_type -> auth.v1.RoleMutationResponse
	29, // 30: auth.v1.AuthService.DeleteRole:output_type -> auth.v1.RoleMutationResponse
	29, // 31: auth.v1.AuthService.AssignRole:output_type -> auth.v1.RoleMutationResponse
	29, // 32: auth.v1.AuthService.RemoveRole:output_type -> auth.v1.RoleMutationResponse
