...
const (
	...
	AuthService_GetUserAuthInfo_FullMethodName       = "/auth.v1.AuthService/GetUserAuthInfo"
	...
	AuthService_SendVerificationEmail_FullMethodName = "/auth.v1.AuthService/SendVerificationEmail"
...
type AuthServiceClient interface {
	...
	CreateRole(ctx context.Context, in *CreateRoleRequest, opts ...grpc.CallOption) (*RoleMutationResponse, error)
	DeleteRole(ctx context.Context, in *DeleteRoleRequest, opts ...grpc.CallOption) (*RoleMutationResponse, error)
	AssignRole(ctx context.Context, in *AssignRoleRequest, opts ...grpc.CallOption) (*RoleMutationResponse, error)
	RemoveRole(ctx context.Context, in *RemoveRoleRequest, opts ...grpc.CallOption) (*RoleMutationResponse, error)
}
...
func (c *authServiceClient) GetUserAuthInfo(ctx context.Context, in *GetUserAuthInfoRequest, opts ...grpc.CallOption) (*GetUserAuthInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserAuthInfoResponse)
	err := c.cc.Invoke(ctx, AuthService_GetUserAuthInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) CreateRole(ctx context.Context, in *CreateRoleRequest, opts ...grpc.CallOption) (*RoleMutationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleMutationResponse)
...
func (c *authServiceClient) DeleteRole(ctx context.Context, in *DeleteRoleRequest, opts ...grpc.CallOption) (*RoleMutationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleMutationResponse)
...
func (c *authServiceClient) AssignRole(ctx context.Context, in *AssignRoleRequest, opts ...grpc.CallOption) (*RoleMutationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleMutationResponse)
...
func (c *authServiceClient) RemoveRole(ctx context.Context, in *RemoveRoleRequest, opts ...grpc.CallOption) (*RoleMutationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleMutationResponse)
...
type AuthServiceServer interface {
	...
	CreateRole(context.Context, *CreateRoleRequest) (*RoleMutationResponse, error)
	DeleteRole(context.Context, *DeleteRoleRequest) (*RoleMutationResponse, error)
	AssignRole(context.Context, *AssignRoleRequest) (*RoleMutationResponse, error)
	RemoveRole(context.Context, *RemoveRoleRequest) (*RoleMutationResponse, error)
...
func (UnimplementedAuthServiceServer) GetUserAuthInfo(context.Context, *GetUserAuthInfoRequest) (*GetUserAuthInfoResponse, error) {
...
func (UnimplementedAuthServiceServer) CreateRole(context.Context, *CreateRoleRequest) (*RoleMutationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateRole not implemented")
}
func (UnimplementedAuthServiceServer) DeleteRole(context.Context, *DeleteRoleRequest) (*RoleMutationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteRole not implemented")
}
func (UnimplementedAuthServiceServer) AssignRole(context.Context, *AssignRoleRequest) (*RoleMutationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AssignRole not implemented")
}
func (UnimplementedAuthServiceServer) RemoveRole(context.Context, *RemoveRoleRequest) (*RoleMutationResponse, error) {
...
func _AuthService_GetUserAuthInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserAuthInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetUserAuthInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetUserAuthInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUserAuthInfo(ctx, req.(*GetUserAuthInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_GetUserAuthInfo_Handler,
		},
		{
			MethodName: "GetJWKS",
